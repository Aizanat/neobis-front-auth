            ...
            <div className="register__form">
              ...
              <label htmlFor={`email`} className="register__form-lable">
                ...
                {touched.email && errors.email && (
                  <p className="register__from-eror">{errors.email}</p>
                )}
              </label>
              ...
              <label htmlFor={`login`} className="register__form-lable">
                ...
                {touched.login && errors.login && (
                  <p className="register__from-eror">{errors.login}</p>
                )}
              </label>
              ...
              <label htmlFor={`password`} className="register__form-pass-lable">
                ...
                <button onClick={handleEye} className="register__form-eye">
                  {/* {show ? (
                    <BsEye className="register__form-eye" />
                  ) : (
                    <BsEyeSlash className="register__form-eye" />
                  )} */}
                </button>
                ...
                <div>
                  {!values.password ? (
                    <li className="register__form-li">От 8 до 15 символов</li>
                  ) : passwordState.length ? (
                    '✅ Длина от 8 до 15 символов'
                  ) : (
                    '❌ Длина от 8 до 15 символов'
                  )}
                </div>
                ...
                <div>
                  {!values.password ? (
                    <li className="register__form-li">
                ...
                <div>
                  {!values.password ? (
                    <li className="register__form-li">Минимум 1 цифр</li>
                ...
                {touched.password && errors.password && (
                  <p className="register__from-eror">{errors.password}</p>
                )}
              </label>

              <label
                htmlFor={`confirmPassword`}
                className="register__form-pass-lable"
              >
                <input
                  type={show ? 'text' : 'password'}
                ...
                {touched.confirmPassword && errors.confirmPassword && (
                  <p className="register__from-eror">
                ...
                style={{
                  background:
                    ...
                    Object.keys(touched).length !==
                      Object.keys(validationsSchema.fields).length
                      ? '#D7D7D7'
                      : 'black',
                  color:
                    !isValid ||
